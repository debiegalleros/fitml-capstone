...
// base list above). Audited against data/catalog/metadata.csv directly;
// anything missing here silently fell back to grey, which read as a
// color mismatch on the card (e.g. an olive variant showing a grey dot).
const COLOR_HEX = {
...
function renderGrid() {
  ...
  grid.innerHTML = items
    .map((item) => {
      ...
      const sizeChartHeader = item.gender === "men"
